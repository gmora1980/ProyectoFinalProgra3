...
Partial Public Class Pacientes1
    ...
    '''<summary>
    '''Control btnSolicitarCita.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents btnSolicitarCita As Global.System.Web.UI.WebControls.Button
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents btnCancelarCita As Global.System.Web.UI.WebControls.Button
