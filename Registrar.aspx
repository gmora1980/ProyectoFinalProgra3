<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Registrar.aspx.vb" Inherits="ProyectoFinalProgra3.Registrar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <main class="card form-signin shadow-lg p-4 m-auto" style="max-width:300px; width:100%; border-radius: 2rem;"">
            <div class="card-body">
                ...
                <div class="form-floating mb-3">
                    <asp:TextBox ID="txtEspecialidad" runat="server" CssClass="form-control" placeholder="Especialidad" />
                    <label style="font-family: 'Times New Roman'; font-size: large; color: black" for="MainContent_txtTelefono">Especialidad</label>
                </div>
                <div class="form-floating mb-3">
